...
import MetaData from "../../more/Metadata";
import CheckoutSteps from "./CheckoutSteps";
import qr from "../../Assets/abshiek-enterprise qr.jpg"
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="px-6 py-8 text-center">
            ...
            <img
              src={qr}
              alt="UPI QR Code"
              className="mx-auto w-64 h-full"
            />
            <p className="mt-4 text-gray-600">Scan this QR code using any UPI app to complete your payment.</p>
          </div>
        </div>
      </div>
    </div>
