        ...
        <>
          ...
          <div className="ProductDetails">
              ...
              <Carousel>
                {product.images &&
                  product.images.map((item, i) => (
                    <img
                      className="CarouselImage h-auto cursor-crosshair"
                      key={i}
                      src={item.url}
                      alt={`${i} Slide`}
                    />
            ...
            <div className="varse__2">
              ...
              <Link to="/shipping">
                <button class="px-3 py-3 bg-cyan-500 text-white font-semibold text-lg rounded-lg shadow-md hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-opacity-50 sm:px-8 sm:py-4 md:px-4 md:py-3 lg:px-4 lg:py-3 font-sans">
                  Go to Checkout
                </button>
              </Link>
            </div>
